...
const BenefitsofJoining = () => {
    ...
    return (
        <div className={` my-8 py-8 space-y-4 ${themeToggle === "dark" ? '': 'bg-[#f5f8f5]'}`}>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 w-11/13 mx-auto gap-6'>
                <div className={`text-center ${themeToggle === "dark" ? 'bg-gradient-to-br from-[#2c3e50] to-[#1c1c1e]': 'bg-white'} p-3 space-y-4 py-19 shadow-lg `}>
