    ...
    return (
        <div>
            ...
            <div className='my-22 grid grid-cols-1 md:grid-cols-3 gap-6 w-11/12 mx-auto'>
                {
                    filteredData.length > 0 ? filteredData.map(onedata => (
                        <div key={onedata._id} className='bg-white shadow-xl rounded-[7px]'>
                            <div className='relative overflow-hidden'>
                                <img className='h-48 w-full object-cover duration-300 transition-transform hover:scale-105' src={onedata.photoURL} alt={onedata.gp_name} />
                        ...
                        <p className="text-center col-span-3 py-6 text-gray-500 text-lg">No matching groups found.</p>
                    )
                }
            </div>
        </div>
